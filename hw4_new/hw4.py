...
def main():
    ...
    '''
    img_reconstruct_pca2 = img_reconstruct_pca.reshape(61, 80)
    plt.imshow(img_reconstruct_pca2, cmap='gray')
    plt.title('Reconstructed Image with PCA')
    plt.show()
    
    img_reconstruct_ae2 = img_reconstruct_ae.reshape(61, 80)
    plt.imshow(img_reconstruct_ae2, cmap='gray')
    plt.title('Reconstructed Image with Autoencoder')
    plt.show()
    
    img_reconstruct_deno_ae2 = img_reconstruct_deno_ae.reshape(61, 80)
    plt.imshow(img_reconstruct_deno_ae2, cmap='gray')
    plt.title('Reconstructed Image with DenoisingAutoencoder')
    plt.show()
    '''
